...
function [phase1,phase2]=PE2D_length2(M_in,data,row_num,row_start,row_end,col_start,col_end,N_in)
    i=0;
    for  k=row_start:M_in-row_end+1 
        data_im=data(k:k+row_num-1,N_in-col_end+1:N_in-col_start+1);
        i=i+1;
        [N,M]=size(data_im);
