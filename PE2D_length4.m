...
function [phase1,phase2]=PE2D_length4(N_in,data,col_num,row_start,row_end,col_start,col_end,M_in)
    i=0;
    for  k=col_start:N_in-col_end+1 
        data_im=data(M_in-row_end+1:M_in-row_start+1,k:k+col_num-1);
        i=i+1;
        [N,M]=size(data_im);
